	...
	<div class="content-wrapper">
		...
		<div class="main-text-area">
			...
			<div class="text3 mt10">
				<a href="http://www.kepco.co.jp/business/yakkan/s-ryoukin/" class="arrow-a-r font-m1">法人のお客さまはこちらをご覧ください</a>
			</div>
		</div>

		<div class="content sec01 mt10">
			<div class="row-2">
				<div class="col-2 w70p">
				...
				<div class="col-2 last-2 w30p mt20">
					<div class="border-a round-a heightLine-g1">
						<h3><span class="inner">値上げ申請に関するご説明</span></h3>
						<ul class="list-def mt30 mb30">
							<li>
								<div class="link-btn"><a href="setsumei/naiyou/">値上げ申請の内容</a></div>
							</li>
							<li>
								<div class="link-btn"><a href="setsumei/haikei/">値上げ申請の背景</a></div>
							</li>
							<li>
								<div class="link-btn"><a href="setsumei/menu/">各種ご契約メニューの申請内容</a></div>
							</li>
							<li>
								<div class="link-btn"><a href="setsumei/sonota/">その他の変更内容</a></div>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="sec03 content">
				<div class="row-2">
					<div class="col1 col-2 w60p round-a mt30 mb30">
						<div class="inner">
							<ul class="list-il">
								<li><div class="link-btn"><a href="tanka/">申請する(届出予定)単価一覧</a></div></li>
								<li><div class="link-btn"><a href="shitsumon/">お客さまの疑問にお答えいたします</a></div></li>
								<li><div class="link-btn"><a href="shiryou/">電気料金の値上げ申請<br />に関する資料</a></div></li>
								<li><div class="link-btn"><a href="setsuyaku/">節約・省エネに役立つ<br />情報のご案内</a></div></li>
							</ul>
						</div>
					</div>
					<div class="col2 col-2 w40p mt30 last-2">
						<ul class="list-def">
							...
							<li><a href="torikumi/"><img src="img/index_sec03_bn02.jpg" alt="関西電力の現状の取り組み" /></a></li>
						</ul>
					</div>
