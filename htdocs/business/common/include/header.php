...
<header id="pc">
	...
	<div class="header-inner">
		<div class="upper cf">
			<h1>
				<a href="http://www.kepco.co.jp/"><img src="<?php echo $rel ?>common/img/header_logo.gif" width="134" height="24" alt="関西電力" /></a>
			</h1>
			<nav class="unav">
				<ul>
					<li><a href="http://www.kepco.co.jp/siteinfo/sitemap/"><img src="<?php echo $rel ?>common/img/header_unav_sitemap.gif" alt="サイトマップ" /></a></li><li><a href="http://www.kepco.co.jp/english/"><img src="<?php echo $rel ?>common/img/header_unav_en.gif" alt="ENGLISH" /></a></li><li><img src="<?php echo $rel ?>common/img/header_unav_txtsize.gif" alt="文字サイズ" /></li><li>
						<ul class="textresizer"><li>小</li><li>中</li><li>大</li></ul>
					</li>
					<li class="ml15">
						Googleカスタム検索
					</li>
...
<header id="sp-header">
	...
	<nav id="dd-menu">
		...
		<ul class="dd-level2">
			<li class="ind"><a href="/kojin/">個人のお客さま</a></li>
			<li class="biz"><a href="/business/">法人のお客さま</a></li>
